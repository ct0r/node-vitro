...
test("`append` with invalid name throws error", (t) => {
  ...
  const error = t.throws(() => headers.append("👎", ""), {
...
test("`delete` with invalid name throws error", (t) => {
  ...
  const error = t.throws(() => headers.delete("👎"), { instanceOf: TypeError });
...
test("`get` with invalid name throws error", (t) => {
  ...
  const error = t.throws(() => headers.get("👎"), { instanceOf: TypeError });
...
test("`has` with invalid name throws error", (t) => {
  ...
  const error = t.throws(() => headers.has("👎"), { instanceOf: TypeError });
...
test("`set` with invalid name throws error", (t) => {
  ...
  const error = t.throws(() => headers.set("👎", ""), {
    instanceOf: TypeError,
  });
