...
module.exports = class Request {
  ...
  get headers() {
    if (!this.__headers) {
      this.__headers = Object.create(Headers.prototype);
      this.__headers.__map = this.__req.headers;
    }
  ...
  get url() {
    ...
    return `http://vitro${this.__req.url}`;
  }
  ...
  text() {
    ...
    return getRawBody(this.__req, { limit, length, encoding })
